...
const Contact = () => {
  return (
    <>
      <section id="contact" className="contacct">
        <div className="mx-auto mt-40 h-[80dvh] content-center text-center">
          <h2 className="mb-4 text-4xl font-bold text-[#45CB85] md:text-[40px]">
            Find me here
          </h2>
